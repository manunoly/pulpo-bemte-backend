...
<body>
    <table>
        ...
        <tr>
            <td ></td> 
            <td class="cuerpo">
                <p class="hola">Bienvenid@ {{$persona}}, te has registrado con éxito</p>
                <p>Queremos contarte un poco más sobre Bemte, la mejor plataforma virtual de ayuda en tareas y clases.<p>
                <p>{{$url}}<p>
